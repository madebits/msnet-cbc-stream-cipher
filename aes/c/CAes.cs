...
public sealed class CAes : IBlockCipher
{
	...
	[DllImport("aesc")] private static extern void aes_encrypt_key(byte[] key, int keyLength, long[] ctx);
	[DllImport("aesc")] private static extern void aes_decrypt_key(byte[] key, int keyLength, long[] ctx);
	[DllImport("aesc")] private static extern void aes_encrypt_key128(byte[] key, long[] ctx);
	[DllImport("aesc")] private static extern void aes_decrypt_key128(byte[] key, long[] ctx);
	[DllImport("aesc")] private static extern void aes_encrypt_key192(byte[] key, long[] ctx);
	[DllImport("aesc")] private static extern void aes_decrypt_key192(byte[] key, long[] ctx);
	[DllImport("aesc")] private static extern void aes_encrypt_key256(byte[] key, long[] ctx);
	[DllImport("aesc")] private static extern void aes_decrypt_key256(byte[] key, long[] ctx);
	[DllImport("aesc")] private static extern void aes_encrypt(byte[] inb, byte[] outb, long[] ctx);
	[DllImport("aesc")] private static extern void aes_decrypt(byte[] inb, byte[] outb, long[] ctx);
